...
| perspective-tilt | 透视倾斜运镜 | camera | 透视倾斜、3D倾斜、X轴旋转、Y轴旋转、透视变形、缓慢运镜、2倍放大、重点推进、perspective tilt | 先把 GitHub 网页录屏当成一张平面正面放大约 2 倍，再在这个放大后的平面上进行 X/Y 轴旋转、透视变形和缓慢运镜 | 使用真实 GitHub 录制，先保持网页平面正面并放大到约 2 倍，再在这个 2 倍平面上逐渐施加明显的 X/Y 轴旋转、透视变形和轻微横纵运镜；保持网页内容清晰，不重绘网页。 | captured-page | `{"perspectivePx":1100,"zoomDurationMs":3000,"tiltDurationMs":2000,"rotateXFrom":0,"rotateXTo":14,"rotateYFrom":0,"rotateYTo":-26,"translateFrom":{"x":0,"y":0},"translateTo":{"x":16,"y":-8},"scaleFrom":1,"scaleTo":2,"easing":"easeInOut"}` |
