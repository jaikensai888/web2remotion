...
| --- | --- | --- | --- | --- | --- | --- | --- |
| camera-zoom | 镜头平滑放大 | camera | 平滑放大、慢慢放大、镜头推进、zoom in | 镜头从页面中心平滑放大到 120% | 使用真实 GitHub 录制，连续推近仓库标题和简介区域，保持真实页面纹理清晰。 | captured-page | `{"scaleFrom":1,"scaleTo":1.2,"origin":"center","easing":"easeInOut"}` |
